  ...
  return (
    ...
    <section>
                ...
                <div className="grid grid-cols-2  gap-7.5 h-[600px] items-center justify-between">
                    ...
                    {/* Left Column */}
                    <div className="bg-black relative flex items-end rounded-sm overflow-hidden justify-end  h-[600px]">
                        <div className="">
                    ...
                    <div className="grid grid-cols-12 gap-8 items-center">
                        ...
                        {/* Right Top */}
                        <div className="h-[284px] relative flex rounded-sm overflow-hidden items-end justify-end bg-black col-span-12">
                        ...
                        {/* Right Bottom left */}
                        <div className="h-[284px] relative flex rounded-sm overflow-hidden items-center justify-center bg-black col-span-6">
